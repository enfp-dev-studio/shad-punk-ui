    ...
    return (
        <div className="h-screen bg-black overflow-hidden relative">
            ...
            <div className="relative z-40 h-full grid grid-cols-[minmax(200px,240px)_1fr_minmax(200px,240px)] lg:grid-cols-[minmax(220px,260px)_1fr_minmax(220px,260px)] grid-rows-[auto_1fr_auto] gap-x-4 lg:gap-x-8">
                ...
                <div
                    className="flex flex-col justify-center px-6 space-y-4"
                    style={{
                        perspective: '800px',
                        perspectiveOrigin: 'right center',
                    }}
                >
                    <div style={{ transform: 'rotateY(15deg)', transformOrigin: 'right center' }}>
                        <Card className="bg-card/40 backdrop-blur-sm border-primary/40">
                ...
                >
                    <div style={{ transform: 'rotateY(-15deg)', transformOrigin: 'left center' }}>
                        ...
                        <Card className="bg-card/40 backdrop-blur-sm border-primary/40 mt-4">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-xs font-mono text-primary flex items-center gap-2">
                ...
                <div className="col-span-3 px-8 pb-4 flex items-end justify-between">
                    ...
                    <div
                        className="w-96 p-4 bg-card/40 backdrop-blur-sm rounded-lg border border-primary/40 cursor-pointer hover:border-primary/60 transition-all"
                    ...
                    <div
                        className="text-right space-y-1 px-4 py-2 rounded border border-cyan-400/50 animate-pulse"
                        style={{
            ...
            {/* Corner Decorations */}
            <div className="absolute top-4 left-4 w-16 h-16 border-l-2 border-t-2 border-primary/40 z-40" />
            <div className="absolute top-4 right-4 w-16 h-16 border-r-2 border-t-2 border-primary/40 z-40" />
            <div className="absolute bottom-4 left-4 w-16 h-16 border-l-2 border-b-2 border-primary/40 z-40" />
            <div className="absolute bottom-4 right-4 w-16 h-16 border-r-2 border-b-2 border-primary/40 z-40" />
        </div>
    );
}
