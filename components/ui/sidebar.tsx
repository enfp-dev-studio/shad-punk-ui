      ...
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            ...
            "has-data-[variant=inset]:bg-card",
            className
          )}
          {...props}
        >
...
function Sidebar({
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "bg-card text-primary border-r border-primary/30",
          className
        )}
        {...props}
      >
  ...
  return (
    <div
      className="group peer hidden md:block text-primary"
      data-state={state}
...
function SidebarGroupContent({
  ...
  return (
    <div
      ...
      className={cn("w-full text-sm font-mono", className)}
      {...props}
    />
  )
}
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden transition-[width,height,padding] font-mono tracking-wide focus-visible:ring-2 focus-visible:ring-ring/50 active:bg-primary/5 active:text-primary disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-primary/5 data-[active=true]:font-bold data-[active=true]:text-primary data-[active=true]:shadow-[inset_0_0_8px_rgba(var(--glow-rgb),0.2)] data-[state=open]:hover:bg-primary/5 data-[state=open]:hover:text-primary group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-primary/5 hover:text-primary text-primary/80",
        outline:
          "shadow-[0_0_0_1px_rgba(var(--glow-rgb),0.3)] hover:bg-primary/5 hover:text-primary hover:shadow-[0_0_0_1px_rgba(var(--glow-rgb),0.5)]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-primary/30 px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "text-primary/70 font-mono tracking-wide",
        "hover:bg-primary/5 hover:text-primary",
        "active:bg-primary/5 active:text-primary",
        "focus-visible:ring-2 focus-visible:ring-ring/50",
        "disabled:pointer-events-none disabled:opacity-50",
        "aria-disabled:pointer-events-none aria-disabled:opacity-50",
        "[&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-primary",
        "data-[active=true]:bg-primary/5 data-[active=true]:text-primary data-[active=true]:font-bold",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
